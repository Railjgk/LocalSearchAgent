...
TRIGGER_TAGS: dict[str, list[str]] = {
    ...
    "康养": ["wellness", "healing"],
    "唱歌": ["karaoke", "group_activity", "group_friendly", "social", "lively"],
    "KTV": ["karaoke", "group_activity", "group_friendly", "social", "lively"],
    "ktv": ["karaoke", "group_activity", "group_friendly", "social", "lively"],
    "卡拉OK": ["karaoke", "group_activity", "group_friendly", "social", "lively"],
    "卡拉ok": ["karaoke", "group_activity", "group_friendly", "social", "lively"],
    "欢唱": ["karaoke", "group_activity", "group_friendly", "social", "lively"],
    "运动": ["sports", "group_activity", "group_friendly", "social"],
    "飞盘": ["sports", "group_activity", "group_friendly", "social"],
    "打球": ["sports", "group_activity", "group_friendly", "social"],
    "球类": ["sports", "group_activity", "group_friendly", "social"],
    "健身": ["sports"],
    "羽毛球": ["sports", "group_activity", "group_friendly", "social"],
    "篮球": ["sports", "group_activity", "group_friendly", "social"],
    # food
    ...
    "打包": ["takeaway_only"],
    "过敏": ["allergy_aware"],
    "坚果过敏": ["allergy_aware", "nut_free"],
    "海鲜过敏": ["allergy_aware", "seafood_free"],
    "不含海鲜": ["allergy_aware", "seafood_free"],
    "避开海鲜": ["allergy_aware", "seafood_free"],
    "不吃海鲜": ["allergy_aware", "seafood_free"],
    "乳糖不耐": ["allergy_aware", "lactose_free"],
    "清真": ["halal_friendly", "no_pork"],
    "穆斯林": ["halal_friendly", "no_pork"],
    "不含猪肉": ["no_pork"],
    "避开猪肉": ["no_pork"],
    "不吃牛羊肉": ["no_beef_lamb"],
    "不能吃牛羊肉": ["no_beef_lamb"],
    ...
    "别喝酒": ["no_alcohol"],
    "不能喝酒": ["no_alcohol"],
    "软一点": ["soft_food", "light_food"],
    "软一些": ["soft_food", "light_food"],
    "别太硬": ["soft_food"],
    "不能太硬": ["soft_food"],
    "不要太硬": ["soft_food"],
    # emotion
    ...
    "带狗": ["pet_friendly"],
    "小狗": ["pet_friendly"],
    "膝盖不好": ["low_walk", "low_intensity"],
    "膝盖不太好": ["low_walk", "low_intensity"],
    "不能走太多": ["low_walk", "low_intensity"],
    "别安排暴走": ["low_walk", "low_intensity"],
    "少步行": ["low_walk", "short_distance"],
    "少走路": ["low_walk", "short_distance"],
    "婴儿车": ["stroller_accessible", "low_walk"],
    "推车": ["stroller_accessible", "low_walk"],
    "少楼梯": ["stroller_accessible", "low_walk"],
    "轮椅": ["low_walk", "low_intensity"],
    "电梯": ["low_walk", "low_intensity"],
    "少台阶": ["low_walk", "low_intensity"],
    "小手术": ["low_walk", "low_intensity"],
    "术后": ["low_walk", "low_intensity"],
